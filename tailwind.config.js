  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "wave-reverse": "wave-reverse 1s ease-in-out infinite",
      ...
      backgroundImage: {
        ...
        "music-gradient": "linear-gradient(135deg, #8B5CF6 0%, #A78BFA 50%, #C4B5FD 100%)",
        "player-gradient": "linear-gradient(135deg, rgba(139, 92, 246, 0.1) 0%, rgba(167, 139, 250, 0.05) 100%)",
        "shimmer-gradient": "linear-gradient(90deg, transparent, rgba(255,255,255,0.2), transparent)",
      },
      boxShadow: {
        "glow": "0 0 20px rgba(139, 92, 246, 0.3)",
        "glow-lg": "0 0 40px rgba(139, 92, 246, 0.4)",
        "player": "0 10px 40px rgba(0, 0, 0, 0.3)",
